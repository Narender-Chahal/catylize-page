...
function MyNav() {
  ...
  return (
    <section className="nav_bg position-relative">
      <div className="nav_blur_circle position-absolute top-0 start-0"></div>
      <div className="nav_blur_circle2 position-absolute top-0 "></div>
        ...
        <nav className="d-flex align-items-center justify-content-between py-4">
          <div className="d-flex align-items-center">
            ...
            <div
              className={
                first === true
                  ? " open_nav d-flex  align-items-center flex-column flex-md-row justify-content-center ms-md-3 ps-md-4"
                  : "close_nav d-flex flex-column align-items-center  flex-md-row justify-content-center ms-lg-5 ms-md-3 ps-md-4 "
              }
            >
              <button
                onClick={() => setfirst(false)}
                className="border-0 rounded-5 bg-white position-absolute top-0 end-0 m-4 d-md-none"
              >
              ...
              >
                ...
                <span className="fw-semibold text-black fs_xl  ">
                  Financial Services
                </span>
              </a>
              <a
                onClick={() => setfirst(false)}
                className="d-flex align-items-center ms-lg-5 ms-md-3 mt-4 mt-md-0 nav_link"
                href="#"
              >
              ...
              <div className="d-md-none d-flex flex-column">
                <button className="fw-semibold border-0 bg-transparent signup_btn clr_green fs_xl  mt-4 mt-md-0">
                  Sign up
                </button>
                <button className="fw-semibold fs_xl clr_green log_in_button  mt-4 mt-md-0">
                  Log in
                  <svg
                    className="ms-3"
                    width="18"
          ...
          <div className="d-none d-md-flex">
            <button className="fw-semibold border-0 bg-transparent signup_btn clr_green fs_xl me-3">
              Sign up
            </button>
            <button className="fw-semibold fs_xl clr_green log_in_button ms-lg-4 ms-3 ms-2 ">
              Log in
              <svg
                className="ms-3"
                width="18"
          ...
          <div
            ...
            className="d-flex h_20 justify-content-between flex-column cursor_pointer d-md-none"
          >
